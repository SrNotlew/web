...
export function VideoContextProvider({ children }){
    ...
    return <VideoContext.Provider value={{handleAdd, handleClose, title, setTitle, link, setLink, titleHandler, handleDelete, handleLike, linkHandler, handleSubmit, handleEdit, id, setId}}>
        {children}
        {openModal && <FormModal />}
